const EnergyUtility = require("utility.energy");
...
function buildOrUpgrade(creep) {
  const extensionSites = creep.room.find(FIND_MY_CONSTRUCTION_SITES, {
    filter: (site) => site.structureType === STRUCTURE_EXTENSION,
  });

  const nonRoadSites = creep.room.find(FIND_MY_CONSTRUCTION_SITES, {
